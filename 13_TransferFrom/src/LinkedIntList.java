...
public class LinkedIntList {
    ...
    public LinkedIntList split(){
        LinkedIntList list = new LinkedIntList();
        for(int i = 0; i < size(); i++){
            list.addSorted(get(i));
        }
        return list;
    }
    ...
    //      come back for further info
    public LinkedIntList transferFrom(LinkedIntList list){
        LinkedIntList innerList = new LinkedIntList();
        int current;
        for (int i = 0; i < 1; i++){
